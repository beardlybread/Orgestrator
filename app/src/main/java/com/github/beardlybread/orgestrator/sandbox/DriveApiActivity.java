...
public class DriveApiActivity extends AppCompatActivity
    ...
    public static final String OP_TYPE =
            "com.github.beardlybread.orgestrator.sandbox.DriveApiActivity.OP_TYPE";

    public static final String OP_BODY =
            "com.github.beardlybread.orgestrator.sandbox.DriveApiActivity.OP_BODY";

    public static final String OP_RESULT =
            "com.github.beardlybread.orgestrator.sandbox.DriveApiActivity.OP_RESULT";
    ...
    private int opType = DriveApiActivity.INVALID;
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        this.progressMessage.setMessage(getString(R.string.drive_api_busy));
        this.credential = GoogleAccountCredential.usingOAuth2(
                getApplicationContext(), Arrays.asList(DriveApiActivity.SCOPE))
    ...
    protected void onStart () {
        ...
        this.opType = intent.getIntExtra(DriveApiActivity.OP_TYPE, DriveApiActivity.INVALID);
        this.opBody = intent.getByteArrayExtra(DriveApiActivity.OP_BODY);
        this.makeRequest();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch(requestCode) {
            case REQUEST_PERMISSION_GET_ACCOUNTS:
                Log.v("DriveApiActivity", "get accounts appears in onActivityResult");
                break;
    ...
    public void makeRequest () {
        ...
        try {
            if (this.request == null)
                throw new DriveApiActivity.InvalidOpBody("An invalid Drive operation was sent.");
    ...
    @AfterPermissionGranted(DriveApiActivity.REQUEST_PERMISSION_GET_ACCOUNTS)
    private void chooseAccount () {
        if (EasyPermissions.hasPermissions(
            ...
            Log.v("DriveApiActivity", "in requestPermissions");
            EasyPermissions.requestPermissions(
                    this,
                    "This app needs to access your Google account (via Contacts).",
                    DriveApiActivity.REQUEST_PERMISSION_GET_ACCOUNTS,
    ...
    public void showErrorDialog (Exception e) {
        e.printStackTrace();
        Log.e("DriveApiActivity", e.getMessage());
        if (e instanceof GooglePlayServicesAvailabilityIOException) {
            ...
            gaa.getErrorDialog(
                    ...
                    DriveApiActivity.REQUEST_GOOGLE_PLAY_SERVICES)
                    .show();
        } else {
    ...
    private class MakeRequest extends AsyncTask<Void, Void, byte[]> {
        ...
        protected void onPostExecute (byte[] output) {
            ...
            Log.d("DriveApiActivity", "in onPostExecute");
            Intent result = new Intent();
            result.putExtra(DriveApiActivity.OP_RESULT, output);
            ...
            if (this.lastError != null) {
                if (this.lastError instanceof UserRecoverableAuthIOException) {
                    startActivityForResult(
                            ...
                            DriveApiActivity.REQUEST_AUTHORIZATION);
                } else {
